...
- [x] The label corner handle scales the label size (audit item 7), as one undo step. <!-- done on ticket 100's branch -->
...
### 2026-09-25: implementer, ticket 100's branch

Claude Opus 5.5 (1M context), Claude Code, medium effort. The fifth criterion and the open Later label were done on ticket 100's branch; see ticket 100's report and its decision in `decisions.md`.
