...
rectangle. Preview sampling happens before any panel is shown. `AreaCaptureSource` compares
the Space generation around asynchronous preparation and discards invalidated
