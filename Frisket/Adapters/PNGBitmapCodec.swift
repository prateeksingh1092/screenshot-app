...
/// PNG bytes to and from the editor preview's premultiplied sRGB RGBA8 bitmap, entirely in memory.
/// No decoded-image cache is kept. Delivered output is `CaptureRenderer.flatten`, not this codec.
