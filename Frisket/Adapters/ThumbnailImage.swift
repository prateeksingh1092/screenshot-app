...
public enum ThumbnailImage {
    public static func make(from pngData: Data, maximumPixelSize: Int) -> CGImage? {
    ...
    @concurrent public static func decode(_ pngData: Data, maximumPixelSize: Int) async -> CGImage? {
